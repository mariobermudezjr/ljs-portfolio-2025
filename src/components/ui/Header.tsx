...
const Header = () => {
  return (
    <HeaderAnimation>
      <nav className="w-10/12 lg:max-w-screen-md flex items-center justify-end flex-row relative py-8 sm:pb-8 bg-primary text-foreground dark:text-white gap-5 lg:gap-0">
